...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a 2D Residual U-Net for T1 MRI denoising.")
...
def main() -> None:
    ...
    model = ResidualUNet2D(base_channels=args.base_channels).to(device)
