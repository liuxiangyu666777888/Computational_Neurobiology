...
\title{Comparing 2D, 2.5D, and 3D Residual U-Nets for T1 MRI Denoising\thanks{Computational Neuroscience Final Project. Task: T1 MRI denoising, \texttt{T1\_noisy.nii.gz} $\rightarrow$ \texttt{T1\_clean.nii.gz}.}}

\author{%
  Liuxiangyu\\
  Student ID: 23307140078
}
